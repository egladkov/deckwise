          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-sm text-navy font-semibold mt-1 block">
                {subscription?.planId === "series-a" ? "Series A+ (Full Access)" : subscription?.planId === "seed" ? "Seed Access" : subscription?.planId === "pre-seed" ? "Pre-Seed Access" : subscription?.planId === "bootstrapper" ? "Bootstrapper Access" : "Free Access"}
              </span>
            </div>
          </div>
        </div>
